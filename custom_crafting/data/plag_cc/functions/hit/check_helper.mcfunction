...
execute store success score @s plag_cc.tmp run data modify storage plag:cc UUID_tmp set from entity @s attack.player

execute if score @s plag_cc.tmp matches 0 run tag @s add active
execute if score @s plag_cc.tmp matches 0 run data remove entity @s attack